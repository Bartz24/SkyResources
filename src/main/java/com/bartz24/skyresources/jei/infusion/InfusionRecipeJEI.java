...
public class InfusionRecipeJEI extends BlankRecipeWrapper
{
	...
	public InfusionRecipeJEI(ItemStack inputStack, ItemStack inputBlock,
			ItemStack output, int healthNeeded)
	{
	...
	public List<String> getTooltipStrings(int mouseX, int mouseY)
	{
		...
		{
			ret.add(I18n
					.translateToLocal("jei.skyresources.recipe.rightClickOn"));
			return ret;
		}
		return null;
	}
