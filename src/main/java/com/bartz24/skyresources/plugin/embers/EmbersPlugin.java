...
public class EmbersPlugin implements IModPlugin
{
	...
	public void init()
	{
		...
		ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(shard, 7), 1400,
				new ArrayList<Object>(Arrays.asList(new ItemStack(ModItems.alchemyComponent, 2, 1),
