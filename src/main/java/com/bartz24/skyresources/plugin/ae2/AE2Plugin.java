...
public class AE2Plugin implements IModPlugin
{
	...
	public void init()
	{
		...
		ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(material, 1, 1), 900,
				new ArrayList<Object>(Arrays.asList(new ItemStack(material, 1, 0), new ItemStack(Items.REDSTONE, 4))));
		...
		ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(material, 1, 15), 1200, new ArrayList<Object>(
		...
		ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(material, 1, 14), 1200,
				new ArrayList<Object>(Arrays.asList(new ItemStack(Blocks.IRON_BLOCK), new ItemStack(Items.DIAMOND))));
		ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(material, 1, 13), 1200,
				new ArrayList<Object>(Arrays.asList(new ItemStack(Blocks.IRON_BLOCK), new ItemStack(material, 1, 10))));
