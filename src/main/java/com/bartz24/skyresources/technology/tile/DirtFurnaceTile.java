...
public class DirtFurnaceTile extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        {
            worldObj.setBlockState(pos, worldObj.getBlockState(pos).withProperty(
					BlockDirtFurnace.BURNING, this.isBurning()));
