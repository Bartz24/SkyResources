...
public class ModCrafting
{
	public static void init()
	{
		...
		GameRegistry
				.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.concentrator),
						new Object[] { "XXX", "XYX", "XZX", 'X', "ingotIron", 'Y',
								new ItemStack(ModBlocks.alchemicalCondenser), 'Z',
								new ItemStack(ModItems.alchemyComponent, 1, 4) }));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.purificationVessel),
				new Object[] { "XXX", "XYX", "XXX", 'X', "blockGlass", 'Y', Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE }));
		...
		InfusionRecipes.addRecipe(new ItemStack(Blocks.SAPLING, 1, 4), new ItemStack(ModItems.alchemyComponent, 10, 1),
				ModBlocks.cactusFruitNeedle, 0, 10);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.APPLE, 10, 0), "treeSapling",
				0, 20);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.DIRT, 1, 1), new ItemStack(ModItems.cactusFruit, 4), Blocks.SAND,
				1, 15);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.CACTUS, 3), new ItemStack(ModItems.alchemyComponent, 6, 1),
				Blocks.CACTUS, OreDictionary.WILDCARD_VALUE, 8);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.DEADBUSH), new ItemStack(Items.ROTTEN_FLESH, 4), "treeSapling",
				0, 10);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.GRASS, 1), new ItemStack(Items.WHEAT_SEEDS, 4), Blocks.DIRT, 0,
				14);
		InfusionRecipes.addRecipe(new ItemStack(Items.APPLE), new ItemStack(Items.SUGAR, 10), Blocks.HAY_BLOCK, 0, 10);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.SAPLING, 1, 5), new ItemStack(Items.GUNPOWDER, 10),
				Blocks.SAPLING, 0, 20);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.SAPLING, 1, 3), new ItemStack(Items.DYE, 10, 3), "treeSapling",
				0, 20);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.SAPLING, 1, 2), new ItemStack(Items.DYE, 10, 15), "treeSapling",
				0, 20);
		InfusionRecipes.addRecipe(new ItemStack(Items.REEDS), new ItemStack(Items.SPECKLED_MELON, 3), Blocks.PUMPKIN,
				OreDictionary.WILDCARD_VALUE, 20);
		InfusionRecipes.addRecipe(new ItemStack(Items.NETHER_WART), new ItemStack(Items.SPIDER_EYE, 8),
				Blocks.RED_MUSHROOM, OreDictionary.WILDCARD_VALUE, 20);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.RED_MUSHROOM), new ItemStack(Items.DYE, 8, 1), Blocks.TALLGRASS,
				OreDictionary.WILDCARD_VALUE, 15);
		InfusionRecipes.addRecipe(new ItemStack(Blocks.BROWN_MUSHROOM), new ItemStack(Items.DYE, 8, 3),
				Blocks.TALLGRASS, OreDictionary.WILDCARD_VALUE, 15);
		InfusionRecipes.addRecipe(new ItemStack(ModItems.healthGem), new ItemStack(ModItems.alchemyComponent, 1, 4),
				Blocks.CHORUS_FLOWER, OreDictionary.WILDCARD_VALUE, 19);

		CombustionRecipes.addRecipe(new ItemStack(Items.COAL, 1), 50, new ItemStack(Items.COAL, 1, 1));
		CombustionRecipes.addRecipe(new ItemStack(Items.BLAZE_POWDER, 1), 75, new ItemStack(Items.GUNPOWDER, 2));
		CombustionRecipes.addRecipe(new ItemStack(Items.DIAMOND, 1, 0), 1000,
				new ItemStack(ModBlocks.compressedCoalBlock, 2));
		CombustionRecipes.addRecipe(new ItemStack(Blocks.SANDSTONE, 8, 1), 200, new ItemStack(Blocks.SAND, 12),
				new ItemStack(Items.DYE, 1, 1));
		CombustionRecipes.addRecipe(new ItemStack(ModItems.metalCrystal, 1, 0), 90, new ItemStack(Blocks.GLASS, 6),
		...
		CombustionRecipes.addRecipe(new ItemStack(ModBlocks.dryCactus), 1300, new ItemStack(boneBlock),
				new ItemStack(Items.DYE, 8, 7), new ItemStack(Blocks.LEAVES, 8, 1));
		CombustionRecipes.addRecipe(new ItemStack(Blocks.CACTUS), 900, new ItemStack(Items.SPIDER_EYE, 1),
				new ItemStack(Items.SNOWBALL, 16), new ItemStack(ModBlocks.dryCactus, 4));

		CombustionRecipes.addRecipe(new ItemStack(Items.REDSTONE, 4), 400, new ItemStack(Items.GUNPOWDER, 2),
				new ItemStack(Items.BLAZE_POWDER, 2));

		CombustionRecipes.addRecipe(new ItemStack(ModItems.alchemyComponent, 2, 2), 400, new ItemStack(Items.COAL, 2),
		...
		CombustionRecipes.addRecipe(new ItemStack(Items.WHEAT_SEEDS, 1), 50, new ItemStack(Blocks.DEADBUSH, 1),
				new ItemStack(Items.FLINT, 2));
		CombustionRecipes.addRecipe(new ItemStack(Blocks.DIRT), 100, new ItemStack(ModItems.baseComponent, 8, 2));
		CombustionRecipes.addRecipe(new ItemStack(Items.SLIME_BALL), 200, new ItemStack(Items.SNOWBALL, 4),
				new ItemStack(ModItems.baseComponent, 4, 2));
		CombustionRecipes.addRecipe(new ItemStack(ModItems.techComponent, 1, 1), 1400,
				new ItemStack(Items.POISONOUS_POTATO, 3), new ItemStack(Items.FERMENTED_SPIDER_EYE, 2),
				new ItemStack(Items.SLIME_BALL, 1), new ItemStack(Items.GUNPOWDER, 2));
		CombustionRecipes.addRecipe(new ItemStack(Items.SNOWBALL), 1234, new ItemStack(Items.POTIONITEM, 1, 0),
				new ItemStack(Items.POTIONITEM, 1, 0), new ItemStack(Items.POTIONITEM, 1, 0),
				new ItemStack(Items.QUARTZ, 8));
		CombustionRecipes.addRecipe(new ItemStack(Blocks.NETHERRACK, 4), 700, new ItemStack(Blocks.COBBLESTONE, 8),
				new ItemStack(Items.REDSTONE, 1), new ItemStack(Items.BLAZE_POWDER, 2));
		...
		CombustionRecipes.addRecipe(new ItemStack(Items.GLOWSTONE_DUST, 5), 900, new ItemStack(Items.REDSTONE, 4),
				new ItemStack(Items.BLAZE_POWDER, 2), new ItemStack(Items.FIRE_CHARGE));
		CombustionRecipes.addRecipe(new ItemStack(Items.QUARTZ, 4), 750, new ItemStack(ModItems.metalCrystal, 1, 11),
				new ItemStack(Items.FLINT, 6), new ItemStack(Items.FIRE_CHARGE));
		CombustionRecipes.addRecipe(new ItemStack(Items.DYE, 8, 4), 988, new ItemStack(ModItems.metalCrystal, 1, 17),
				new ItemStack(Items.FLINT, 6), new ItemStack(Blocks.STONE, 3));

		CombustionRecipes.addRecipe(new ItemStack(Blocks.END_STONE, 1), 1369, new ItemStack(Blocks.STONE, 6, 3),
				new ItemStack(Items.SUGAR, 2), new ItemStack(Items.ENDER_PEARL, 4), new ItemStack(Items.QUARTZ, 2),
				new ItemStack(boneBlock, 4));

		RockGrinderRecipes.addRecipe(new ItemStack(Blocks.SAND), false, Blocks.COBBLESTONE.getDefaultState());
		RockGrinderRecipes.addRecipe(new ItemStack(Blocks.GRAVEL), false, Blocks.SANDSTONE.getDefaultState());
		RockGrinderRecipes.addRecipe(new ItemStack(Items.FLINT), false, Blocks.GRAVEL.getDefaultState());
		...
		for (int i = 0; i < ModFluids.moltenCrystalFluidInfos().length; i++)
		{
			CrucibleRecipes.addRecipe(new FluidStack(ModFluids.moltenCrystalFluids.get(i), 1000),
					new ItemStack(ModItems.metalCrystal, 1, ModFluids.moltenCrystalFluidInfos()[i].crystalIndex));
		}
		CrucibleRecipes.addRecipe(new FluidStack(FluidRegistry.LAVA, 200),
				new ItemStack(ModBlocks.compressedNetherrack));

		CrucibleRecipes.addRecipe(new FluidStack(FluidRegistry.LAVA, 250), new ItemStack(ModBlocks.blazePowderBlock));
		...
		WaterExtractorRecipes.addInsertRecipe(Blocks.CLAY.getDefaultState(), false, Blocks.DIRT.getDefaultState(),
				1000);

		FreezerRecipes.addRecipe(new ItemStack(ModItems.heavySnowball), 100, new ItemStack(Items.SNOWBALL, 4));
		FreezerRecipes.addRecipe(new ItemStack(Blocks.DIRT, 1, 1), 800, new ItemStack(ModBlocks.heavySnow2, 2));
		FreezerRecipes.addRecipe(new ItemStack(Items.SLIME_BALL), 1200, new ItemStack(Items.MAGMA_CREAM));
		FreezerRecipes.addRecipe(new ItemStack(Blocks.ICE), 2000, new ItemStack(Items.POTIONITEM, 1, 0));
		FreezerRecipes.addRecipe(new ItemStack(ModItems.techComponent, 1, 2), 3000, new ItemStack(Items.IRON_INGOT));
		FreezerRecipes.addRecipe(new ItemStack(Blocks.SOUL_SAND), 1500, new ItemStack(ModBlocks.sandyNetherrack));
		...
		for (int i = 0; i < ModFluids.crystalFluidInfos().length; i++)
		{
			...
			if (OreDictionary.getOres(oreName).size() > 0)
			{
				ConcentratorRecipes.addRecipe(
						...
						new ItemStack(ModItems.metalCrystal, ConfigOptions.crystalConcentratorAmount,
		...
		for (int i = 0; i < ModFluids.moltenCrystalFluidInfos().length; i++)
		{
			String oreName = "ore" + RandomHelper.capatilizeString(ModFluids.moltenCrystalFluidInfos()[i].name);
		...
		ConcentratorRecipes.addRecipe(Blocks.COAL_ORE.getDefaultState(), 100,
				new ItemStack(ModItems.alchemyComponent, 1, 2), ModBlocks.compressedStone.getDefaultState());

		ConcentratorRecipes.addRecipe(Blocks.DIAMOND_ORE.getDefaultState(), 800,
				new ItemStack(ModItems.alchemyComponent, 1, 4), ModBlocks.compressedStone.getDefaultState());

		ConcentratorRecipes.addRecipe(Blocks.REDSTONE_ORE.getDefaultState(), 700,
				new ItemStack(ModItems.alchemyComponent, 12, 3), ModBlocks.compressedStone.getDefaultState());

		if (OreDictionary.getOres("oreUranium").size() > 0)
		{
			ConcentratorRecipes.addRecipe(
					Block.getBlockFromItem(OreDictionary.getOres("oreUranium").get(0).getItem())
							.getStateFromMeta(OreDictionary.getOres("oreUranium").get(0).getMetadata()),
					1500, new ItemStack(ModItems.techComponent, 4, 1), ModBlocks.compressedStone.getDefaultState());
		}
		...
		for (FluidRegisterInfo i : ModFluids.crystalFluidInfos())
		{
			...
			{
				CauldronCleanRecipes.addRecipe(OreDictionary.getOres(dust).get(0), 1F / ((float) i.rarity * 9F),
