...
public class ModAchievements
{
	...
	public static final Achievement firstWater = new Achievement("firstWater",
			...
			firstSapling).registerStat();

	public static final Achievement lavaMelting = new Achievement("lavaMelting",
			"LavaMelting", 4, 3, new ItemStack(ModBlocks.blazePowderBlock),
			firstSapling).registerStat();

	public static AchievementPage modAchievePage = new AchievementPage(
			"Sky Resources", cactusNeedle, firstSapling, firstWater,
			lavaMelting);
}
