package com.bartz24.skymod.technology.block;
...
import com.bartz24.skymod.base.block.IMetaBlockName;
...
public class CombustionHeaterBlock extends BlockContainer implements IMetaBlockName
{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
		if (!world.isRemote)
		{
			player.openGui(SkyMod.instance, ModGuiHandler.CombustionHeaterGUI, world, pos.getX(),
					pos.getY(), pos.getZ());
		}
		return true;
    }
