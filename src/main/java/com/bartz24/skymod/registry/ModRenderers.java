...
import com.bartz24.skymod.technology.block.CombustionHeaterBlock.CombustionHeaterVariants;
...
public class ModRenderers
{
	public static void preInit()
	{
		...
		ModelLoader.registerItemVariants(ModItems.waterExtractor,
				new ModelResourceLocation("skymod:WaterExtractor.empty",
						"inventory"), new ModelResourceLocation(
						"skymod:WaterExtractor.full1", "inventory"),
				new ModelResourceLocation("skymod:WaterExtractor.full2",
						"inventory"), new ModelResourceLocation(
						"skymod:WaterExtractor.full3", "inventory"),
				new ModelResourceLocation("skymod:WaterExtractor.full4",
						"inventory"), new ModelResourceLocation(
						"skymod:WaterExtractor.full5", "inventory"),
				new ModelResourceLocation("skymod:WaterExtractor.full6",
						"inventory"));
