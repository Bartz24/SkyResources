...
import com.bartz24.skymod.proxy.CommonProxy;

@Mod(modid = References.ModID, name = References.ModName, useMetadata = true)
public class SkyMod
{
	@SidedProxy(clientSide = "com.bartz24.skymod.proxy.ClientProxy", serverSide = "com.bartz24.skymod.proxy.ServerProxy")
